# Generated by Powerlevel10k configuration wizard on 2020-11-15 at 19:57 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#f0c674'
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#f0c674'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND='#dfdfdf'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%B[%F{#8abeb7}%m%f]'
  ...
  function prompt_onlyname() {
    #p10k segment -t '[%n]'
    p10k segment -f '#dfdfdf' -t '%B[%n]%%'
  }
